...
function RenderTestimonial(
    Components\Views\Common\Testimonial $_component,
    ...
    $_content .= '<div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
